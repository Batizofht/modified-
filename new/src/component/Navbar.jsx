...
<div className="offcanvas offcanvas-end bg-primary "  style={{borderTopLeftRadius:10, borderBottomLeftRadius:10,width:200}} data-bs-scroll="true" tabIndex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
 ...
 <div className='mt-3'>
     <Link to='/Admins' style={{color:"blue",marginRight:-20}}  className="navbar-text btn btn-light  fw-bold rounded-pill">
      ...
      <h6 className="offcanvas-title text-light py-3" id="offcanvasWithBothOptionsLabel ">Jesuits Community</h6>
