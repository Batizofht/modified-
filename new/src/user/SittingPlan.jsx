...
const SittingPlan = () => {
   ...
   const [waitings2, setWaitings2] = useState(false);
    ...
    const olevel = async () => {
      let roomNumber = 1;
      const baseURL = "http://localhost:8080/project/phpbackened/virtual_class/olevel.php?";
      let response = null;
    ...
    const clearo = async () => {
      try {
        const response = await axios.get("http://localhost:8080/project/phpbackened/controll.php?clearolevel=www");
        const data = response.data;
